...
Karten ohne Trigger, die aber Stat-Felder (`ATK`, `DEF`, `SPD`) tragen, wirken **passiv**: `calculateStats()` rechnet sie automatisch ein, solange die Karte sichtbar auf dem Spielfeld liegt. Beispiel: *Schwächung* (`ATK: -2, DEF: -2, SPD: -2`).
